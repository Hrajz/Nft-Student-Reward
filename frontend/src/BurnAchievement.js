  ...
  const burnAchievement = async () => {
      ...
      },
      {
        ...
        outputs: [
          ...
          },
          {
            ...
            internalType: "struct RewardNFT.Achievement[]",
            name: "",
            type: "tuple[]",
          },
        ],
    ...
    try {
      if (window.ethereum) {
        ...
        alert("Achievement burned successfully");
      } else {
        alert("Please install MetaMask");
      }
    } catch (err) {
      setError("Failed to burn achievement: " + err.message);
      console.error(err);
    } finally {
      setLoading(false);
    }
...
export default BurnAchievement;
